...
class ShowEstimulacionPersonas extends Component {
  ...
  peticionPut = async () => {
    ...
    try {
      await axios.put(url + this.state.form.id_personal_estimulacion, this.state.form);
      this.modalInsertar();
  ...
  peticionDelete = async () => {
    try {
      await axios.delete(url + this.state.form.id_personal_estimulacion);
  ...
  render() {
    const { form, totalRecords, rowsPerPage, currentPage, personal_estimulaciones, searchTerm, isSearching } = this.state;
          ...
          <div className="card border-0 shadow-lg mb-4" style={{ borderRadius: '20px' }}>
            <div className="card-header border-0 py-4" style={{ 
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  <h3 className="mb-1 text-white fw-bold">Gestión de Personal de Estimulación</h3>
                  <p className="mb-0 text-white opacity-75">Administra y controla el registro del personal</p>
                </div>
                <div className="d-flex align-items-center">
                  <div className="me-3 text-white">
                    <small>Total: {totalRecords} registros</small>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card border-0 shadow-sm" style={{ borderRadius: '15px' }}>
                <div className="table-responsive">
                  <table className="table table-hover mb-0 modern-table">
                    ...
                    <tbody>
                      {personal_estimulaciones.length === 0 ? (
                        <tr>
                        ...
                        personal_estimulaciones.map((persona, index) => {
                          return (
                            <tr key={persona.id_personal_estimulacion} className="hover-row">
                              <td className="border-0 py-3 px-4">
                                <span className="badge rounded-pill px-3 py-2" style={{
                                  background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
                                  color: 'white'
                                }}>
                                  {persona.id_personal_estimulacion}
                                </span>
                              </td>
                              <td className="border-0 py-3 px-4">
                                <div className="d-flex align-items-center">
                                  <span className="fw-semibold">{persona.nombre}</span>
                                </div>
                              </td>
                              ...
                              <td className="border-0 py-3 px-4 text-center">
                                <div className="d-flex gap-2 justify-content-center">
                                  <button 
                                    ...
                                    style={{
                                      background: 'linear-gradient(135deg,rgb(66, 98, 239) 0%, #764ba2 100%)',
                                      border: 'none',
                                      borderRadius: '10px',
                                      color: 'white',
                                      padding: '8px 12px'
                                  ...
                                  <button 
                                    ...
                                    style={{
                                      background: 'linear-gradient(135deg, #f093fb 0%,rgb(243, 6, 37) 100%)',
                                      border: 'none',
                                      borderRadius: '10px',
                                      color: 'white',
                                      padding: '8px 12px'
            ...
            <div className="d-flex align-items-center">
              ...
              <div>
                <h4 className="mb-1 fw-bold">
                  {this.state.tipoModal === 'insertar' ? 'Nueva Persona' : 'Editar Persona'}
                </h4>
          ...
          <ModalBody className="px-4 py-3">
            <div className="row">
              <div className="col-12">
                {this.state.tipoModal === 'actualizar' && (
                  <div className="form-group mb-3">
                    ...
                    <input 
                      ...
                      id="id_personal_estimulacion" 
                      readOnly 
                      onChange={this.handleChange} 
                      value={form ? form.id_personal_estimulacion : ''}
                      style={{
                        borderRadius: '10px',
                ...
                <div className="form-group mb-3">
                  <label htmlFor="nombre" className="form-label fw-semibold" style={{ color: 'white' }}> 
                    👤 Nombre
                  </label>
                  <input 
                    className="form-control" 
